...
// Source: model/repository/user.go
//
// Generated by this command:
//
//	mockgen -source=model/repository/user.go -destination=test/mocks/user_repository_mock.go -package=mocks
//
...
import (
	...
	error_handle "github.com/MogLuiz/go-person-api/configuration/error_handle"
	model "github.com/MogLuiz/go-person-api/model"
...
func (m *MockUserRepository) CreateUser(userDomain model.UserDomainInterface) (model.UserDomainInterface, *error_handle.ErrorHandle) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "CreateUser", userDomain)
	ret0, _ := ret[0].(model.UserDomainInterface)
	ret1, _ := ret[1].(*error_handle.ErrorHandle)
	return ret0, ret1
}
...
func (m *MockUserRepository) DeleteUser(userID string) *error_handle.ErrorHandle {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "DeleteUser", userID)
	ret0, _ := ret[0].(*error_handle.ErrorHandle)
	return ret0
}
...
func (m *MockUserRepository) FindUserByEmail(email string) (model.UserDomainInterface, *error_handle.ErrorHandle) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByEmailAndPassword(email, password string) (model.UserDomainInterface, *error_handle.ErrorHandle) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) FindUserByID(id string) (model.UserDomainInterface, *error_handle.ErrorHandle) {
	m.ctrl.T.Helper()
...
func (m *MockUserRepository) UpdateUser(userID string, userDomain model.UserDomainInterface) *error_handle.ErrorHandle {
	m.ctrl.T.Helper()
